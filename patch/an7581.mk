...
define Device/bell_xg-040g-md
  ...
  DEVICE_PACKAGES := airoha-en7581-npu-firmware kmod-airoha-eth kmod-airoha-npu kmod-phy-airoha-en8811h kmod-i2c-an7581 kmod-leds-gpio kmod-gpio-button-hotplug uboot-envtools ubi-utils kmod-usb-storage-uas kmod-usb-net-cdc-ether kmod-fs-vfat kmod-fs-exfat kmod-fs-ext4 kmod-fs-ntfs3 blkid lsblk
endef
